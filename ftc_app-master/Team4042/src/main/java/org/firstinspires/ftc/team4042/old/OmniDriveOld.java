package org.firstinspires.ftc.team4042.old;
...
public class OmniDriveOld {
    ...
    /**
     * Constructor for OmniDrive, it creates the motors and the gyro objects
     *
     * @param hardwareMap hardware map of robot so OmniDrive can use motors
     * @param gyroName name of gyro in config file to initialize it
     * @param telemetry telemetry so OmniDrive can send data to the phone
     */
    public OmniDriveOld(HardwareMap hardwareMap, String gyroName, Telemetry telemetry) {
